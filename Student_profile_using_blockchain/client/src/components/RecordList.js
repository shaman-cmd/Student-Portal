    ...
    render() {
        ...
        (
            arr.map(arr =>
            {
              ...
              if(arr.record_id!=0)
              {
                var toLink = "http://cert-blog.infura-ipfs.io/ipfs/bafybeianwe4vy7sprht5sm3hshvxjeqhwcmvbzq73u55sdhqngmohkjgs4/#/explore/" + arr.ipfsHash;
                var download = "http://cert-blog.infura-ipfs.io/ipfs/" + arr.ipfsHash;
            return (
